pipeline {
  ...
  environment {
    SERVICE_NAME = 'ekoru-marketplace'
  }
  ...
  stages {
    ...
    stage('Deploy Production') {
      ...
      steps {
        sh '''
          cp /opt/ekoru/secrets/ekoru-marketplace/.env.prod ${WORKSPACE}/.env.prod
