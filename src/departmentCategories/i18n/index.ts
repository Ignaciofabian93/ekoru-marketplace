...
const TRANSLATIONS: TranslationMap = {
  ...
  'errors.category_not_found_id': {
    [Language.ES]: "Categoría con id '{id}' no encontrada",
    [Language.EN]: "Category with id '{id}' not found",
    [Language.FR]: "Catégorie avec l'id '{id}' introuvable",
    [Language.PT]: "Categoria com id '{id}' não encontrada",
    [Language.DE]: "Kategorie mit ID '{id}' nicht gefunden",
  },
...
/**
 * I18N Service - Stateless language utilities for the departmentCategories subdomain
 *
 ...
 */
@Injectable()
export class I18nDepartmentCategoryService {
